...
이 디렉터리는 실제 실행 단위인 todo를 개별 문서로 관리하는 곳입니다.

## Now

- [organize_mac_related_files.md](organize_mac_related_files.md)
- [modify_haven_and_hearth_client.md](modify_haven_and_hearth_client.md)

## Backlog

- [organize_windows_related_files.md](organize_windows_related_files.md)
- [organize_work_register.md](organize_work_register.md)
- [review_linking_bin_instead_of_path.md](review_linking_bin_instead_of_path.md)
- [add_periodic_git_push_for_second_brain.md](add_periodic_git_push_for_second_brain.md)
- [develop_custom_ai.md](develop_custom_ai.md)
- [remove_terminal_screen_record_permission_and_restart.md](remove_terminal_screen_record_permission_and_restart.md)
- [move_existing_haven_and_hearth_todo_here.md](move_existing_haven_and_hearth_todo_here.md)
...
- [add_todo_feature.md](add_todo_feature.md)
