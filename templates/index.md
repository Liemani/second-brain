...
- `thought.md`: 아직 idea나 issue로 정리되지 않은 생각을 관리하는 템플릿
- `idea.md`: 아직 task로 확정되지 않은 아이디어를 관리하는 템플릿
- `issue.md`: 아직 해결되지 않은 문제를 관리하는 템플릿
- `todo.md`: 실제 실행 단위를 관리하는 템플릿
...
- 실제 실행 단위를 개별 문서로 관리할 때 사용합니다.
- 특정 task에 속할 수도 있고, 독립적으로 존재할 수도 있습니다.
...
- 상태, 생성일, 관련 todo, 관련 기록, 관련 결정을 함께 둡니다.
